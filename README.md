# Omega
Use syscalls ZwCreateSection and ZwMapViewOfSection and GetDelegateForFunctionPointer to start shellcode. Shellcode is embedded at C# class(s)
Execution: rundll32 Omega.log,#1 or rundll32 Omega.log,exec 
Try use extensions .bin, .log, .edb and .db if you test ASR rules. 
